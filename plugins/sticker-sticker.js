...
if (!img) return conn.reply(m.chat, `🩵  *_Responde a un vídeo, imagen o Gif para generar tu sticker._*`, m, rcanal)
...
if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: packname, body: `🩵 ̸̷᮫໊᷐͢᷍ᰍ ISAGI 2.0`, mediaType: 2, sourceUrl: redes, thumbnail: icons}}}, { quoted: m })
